...
public class CadenaSumaNumeros {
	...
	public static void main(String[] args) {
		// Escribe un programa que encuentre los números es una cadena y los
		// sume.
		// Por ejemplo, si le damos la cadena
		// "en programación 2 más 2 no son siempre 4, 24 de Abril de 2014."
		// deverá devolver 2046.

		Scanner teclado = new Scanner(System.in);

		System.out.println("Introduce una cadena y el programa sumará los números:");
